...
Asking a model about CloudFall works much better if you give it the docs. Every page
...
| `/llms-full.txt?program=cloudfall` | Just CloudFall, in one response |
| `/raw/cloudfall/<page>` | One page's markdown — e.g. `/raw/cloudfall/faq` |
...
curl -s https://<this-site>/llms-full.txt?program=cloudfall > cloudfall-docs.md
```
