  ...
  return (
    <div className="embed-page">
      ...
      <header className="embed-page__head">
        ...
        <h1 className="display embed-page__title">
          Put these docs in your page
        </h1>
      ...
      {targets.length > 0 ? (
        ...
        <p>
          There&apos;s no content yet. Add a folder under <code>content/</code>{" "}
      ...
      <section className="embed-page__notes prose">
        ...
        <p>
          Every page is also plain markdown, so an agent or a person pasting
          into a chat gets the source rather than a rendering.
        </p>
        <ul>
          <li>
            <a href="/llms.txt">
          ...
          <li>
            ...
            markdown, which is what the <strong>Copy as Markdown</strong> button
            at the foot of every page copies.
          </li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            ...
            footer and page texture before first paint; <code>?nav=0</code>{" "}
            drops the header and contents rail too, for a host page that already
            has its own.
          </li>
          <li>
            <strong>One appearance.</strong> These docs are light only no theme
            to negotiate with your page, and no switch for a reader to get
            wrong.
          </li>
          <li>
          ...
          <li>
            <strong>The round comes with it.</strong> The header carries how
            long is left and a join button while the program is open, and
            neither appears once it has closed.
          </li>
          <li>
